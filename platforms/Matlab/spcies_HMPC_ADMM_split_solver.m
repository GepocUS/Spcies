...
function [u, k, e_flag, Hist] = spcies_HMPC_ADMM_split_solver(x0, xr, ur, varargin)
    ...
    par.FunctionName = 'spcies_HMPC_ADMM_split_solver';
    ...
    options = Spcies_options('formulation', 'HMPC', 'method', 'ADMM', 'submethod', 'split', 'options', options);
    ...
    var = HMPC.compute_HMPC_ADMM_split_ingredients(controller, options);
    N = var.N;
    n = var.n;
    m = var.m;
    n_y = var.n_y;
