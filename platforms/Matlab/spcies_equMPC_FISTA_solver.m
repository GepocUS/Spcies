...
function [u, k, e_flag, Hist] = spcies_equMPC_FISTA_solver(x0, xr, ur, lambda, varargin)
    ...
    def_options = equMPC.def_options_equMPC_FISTA(); % Default values of the options of the solver
    ...
    options = Spcies_options('formulation', 'equMPC', 'method', 'FISTA', 'options', options);
