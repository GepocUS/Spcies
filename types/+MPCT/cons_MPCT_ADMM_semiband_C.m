...
function constructor = cons_MPCT_ADMM_semiband_C(recipe)
    ...
    constCell = add_line(constCell, 'G', vars.G, 1, precision, var_options);
...
%     constCell = add_line(constCell, 'Gamma_hat', vars.Gamma_hat, 1, precision, var_options);
%     constCell = add_line(constCell, 'Gamma_hat_inv', vars.Gamma_hat_inv, 1, precision, var_options);
    constCell = add_line(constCell, 'U_hat', vars.U_hat, 1, precision, var_options);
%     constCell = add_line(constCell, 'V_hat', vars.V_hat, 1, precision, var_options);
%     constCell = add_line(constCell, 'Gamma_tilde', vars.Gamma_tilde, 1, precision, var_options);
%     constCell = add_line(constCell, 'Gamma_tilde_inv', vars.Gamma_tilde_inv, 1, precision, var_options);
    constCell = add_line(constCell, 'U_tilde', vars.U_tilde, 1, precision, var_options);
%     constCell = add_line(constCell, 'V_tilde', vars.V_tilde, 1, precision, var_options);
