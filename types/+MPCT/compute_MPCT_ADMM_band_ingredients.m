...
%     dGamma_tilde = decomposition(Gamma_tilde,'banded'); % Decomposition object of Gamma_tilde
    ...
    vars.S = S;
    vars.G = G;
    vars.Gamma_hat = Gamma_hat; % Note: Gamma_hat is taken as a vector with the elements of the diagonal of the original Gamma_hat
    vars.Gamma_hat_inv = Gamma_hat_inv; % Same with its inverse
    vars.U_hat = U_hat;
    vars.V_hat = V_hat;
