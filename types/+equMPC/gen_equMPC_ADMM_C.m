...
function gen_equMPC_ADMM_C(vars, options, spcies_options)
    ...
    controller_text = fileread([this_path '/struct_equMPC_ADMM_C_plain.c']);
    
    solver_text = fileread([this_path '/code_equMPC_ADMM_C.c']);
    
    header_text = fileread([this_path '/header_equMPC_ADMM_C.h']);
