...
%
% Computes the ingredients of the SADMM-based solver for HMPC for the
% version which projects onto SOCs instead of the "diamond" sets.
%
...
function var = compute_HMPC_SADMM_SOC_ingredients(controller, options, spcies_options)
