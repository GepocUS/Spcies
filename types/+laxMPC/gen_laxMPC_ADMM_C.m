...
function gen_laxMPC_ADMM_C(vars, options, save_name, directory, override)
    ...
    [varsCell, idx] = addLine(varsCell, idx, 'LB', vars.LB, 1, 'double', const_type);
    [varsCell, idx] = addLine(varsCell, idx, 'UB', vars.UB, 1, 'double', const_type);
    ...
    controller_text = fileread([this_path '/struct_laxMPC_ADMM_C_plain.c']);
