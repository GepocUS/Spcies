...
function gen_MPCT_EADMM_Arduino(str, options, save_name)
    ...
    [vars, idx] = addLine(vars, idx, 'rho_0', str.rho_0, 1, 'float', 'constant');
    [vars, idx] = addLine(vars, idx, 'rho_s', str.rho_s, 1, 'float', 'constant');
    [vars, idx] = addLine(vars, idx, 'LB', str.LB, 1, 'float', 'constant');
    [vars, idx] = addLine(vars, idx, 'UB', str.UB, 1, 'float', 'constant');
    [vars, idx] = addLine(vars, idx, 'LB0', str.LB0, 1, 'float', 'constant');
    [vars, idx] = addLine(vars, idx, 'UB0', str.UB0, 1, 'float', 'constant');
    [vars, idx] = addLine(vars, idx, 'LBs', str.LBs, 1, 'float', 'constant');
    [vars, idx] = addLine(vars, idx, 'UBs', str.UBs, 1, 'float', 'constant');
